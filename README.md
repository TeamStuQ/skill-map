...
目前技能图谱已有如下领域，点击标题可以预览文本文件（.md），也可以在[『脑图 Design by StuQ』](https://github.com/TeamStuQ/skill-map/blob/master/data/source-skillmap-PNG-DesignByStuQ.md)以技能树形式预览（.png）：
...
[- DevOps](https://github.com/TeamStuQ/skill-map/blob/master/data/map-DevOps.md)|[@林帆 ](https://github.com/linfan)｜ThoughtWorks DevOps 咨询师|-|[推荐](https://github.com/TeamStuQ/skill-map/issues/107)｜[脑图]
